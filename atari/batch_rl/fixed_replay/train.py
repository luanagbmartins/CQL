...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--replay-dir",
        type=str,
        default=os.path.join("cql-dataset"),
    )
    parser.add_argument("--base-dir", type=str, default=os.path.join("runs"))
    parser.add_argument("--agent-name", type=str, default="quantile")
    parser.add_argument(
        "--gin-files",
        type=str,
        default=str([os.path.join("batch_rl/fixed_replay/configs/quantile.gin")]),
    )
